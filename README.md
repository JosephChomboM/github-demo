...
See [`.github/copilot-instructions.md`](.github/copilot-instructions.md) for the repository-wide coding standards and [`.github/instructions/`](.github/instructions/) for path-specific guidance. In particular, comments should explain intent rather than restate code, exported data-layer functions should include TSDoc/JSDoc for their purpose, parameters, and return values, and reusable Astro components should document their `Props` interface.
